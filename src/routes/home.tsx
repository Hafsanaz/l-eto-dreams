...
export const Route = createFileRoute("/home")({
  head: () => ({
    meta: [
      { title: "L'ETO Bakeshop — Premium Cakes & Desserts" },
      {
        name: "description",
        content:
          "Freshly baked happiness — handcrafted Nutella, Lotus, Ferrero & San Sebastian cakes. Takeaway or delivery.",
      },
      { property: "og:title", content: "L'ETO Bakeshop — Premium Cakes" },
