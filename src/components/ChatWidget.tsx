...
//
// Usage: import ChatWidget from "@/components/ChatWidget";
// then render <ChatWidget /> once, near the bottom of your root layout
// (e.g. in App.tsx), so it floats on every page.
